...
user_invest_type = input(
    "Enter either 'investment' or 'bond' from menu above: "
).lower()
...
if user_invest_type == "investment":
    ...
    if interest == "simple":
        ...
        print(
            "Invalid option selected.please ensure you selected 'compound' or 'simple'."
        )
        exit()
    # Print the total amount after interest
    print(
        f"The total amount after {years} at {interest_rate}% interest will be be {total_amount}. "
    )
